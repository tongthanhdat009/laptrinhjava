...
public class GUILogin extends JFrame implements ActionListener{
    ...
    public GUILogin() {
            ...
            ImageIcon imgFb = new ImageIcon("doan/src/laptrinhjava/src/asset/img/icon/fb-icon.png");
            ImageIcon imgGg = new ImageIcon("doan/src/laptrinhjava/src/asset/img/icon/gg-icon.png");
            ImageIcon imgIc = new ImageIcon("doan/src/laptrinhjava/src/asset/img/icon/apple-icon.png");
            ImageIcon imgXb = new ImageIcon("doan/src/laptrinhjava/src/asset/img/icon/xb-icon.png");
